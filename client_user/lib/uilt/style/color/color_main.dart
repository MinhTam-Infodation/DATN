...
Color tara = const Color.fromRGBO(222, 245, 229, 1);
Color padua = const Color.fromRGBO(188, 234, 213, 1);
Color sinbad = const Color.fromRGBO(158, 213, 197, 1);
Color shadowGreen = const Color.fromRGBO(142, 195, 176, 1);
